...
namespace LOZ.Tools.EnemyObjects
{
    internal class RopeSprite : ISpriteEnemy
    {
        ...
        {
            Rectangle[] ropeFrames = new[] { new Rectangle(126, 59, 16, 16), new Rectangle(143, 59, 16, 16) };

            if (enemyState == 0)
            {
                anim = ropeFrames[(int)(gameTime.TotalGameTime.TotalMilliseconds / (50 * ropeFrames.Length)) % ropeFrames.Length];
