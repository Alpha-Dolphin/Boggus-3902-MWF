...
namespace LOZ.Tools.GateObjects
{
    internal class NorthBombHole : IGate
    {
        ...
        private Sprite openSprite = new Sprite(Game1.ENVIRONMENT_SPRITESHEET, xPosition, yPosition, new List<Rectangle>() { new Rectangle(947, 11, 32, 32) });
        public void Open()
        {
            doorOpen = true;
        }
        ...
        {
            NorthBombHole.xPosition = rect.X;
            NorthBombHole.yPosition = rect.Y;
