...
namespace LOZ.Tools.GateObjects
{
    internal class SouthBombHole : IGate
    {
        ...
        private Sprite openSprite = new Sprite(Game1.ENVIRONMENT_SPRITESHEET, xPosition, yPosition, new List<Rectangle>() { new Rectangle(947, 110, 32, 32) });
        public void Open()
        {
            doorOpen = true;
        }
        ...
        {
            SouthBombHole.xPosition = rect.X;
            SouthBombHole.yPosition = rect.Y;
