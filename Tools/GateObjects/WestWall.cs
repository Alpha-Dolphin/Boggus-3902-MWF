...
namespace LOZ.Tools.GateObjects
{
    internal class WestWall : IGate
    {
        ...
        private Sprite closedSprite = new Sprite(Game1.ENVIRONMENT_SPRITESHEET, GateConstants.WEST_INITIAL_X, GateConstants.WEST_INITIAL_Y, new List<Rectangle>() { new Rectangle(815, 44, 32, 32) });
        private Sprite openSprite = new Sprite(Game1.ENVIRONMENT_SPRITESHEET, GateConstants.WEST_INITIAL_X, GateConstants.WEST_INITIAL_Y, new List<Rectangle>() { new Rectangle(815, 44, 32, 32) });
        public void Open()
        {
