...
namespace LOZ.Tools.ItemObjects
{
    internal class HeartContainer : IItem
    {
        ...
        private Vector2 DefaultSize = new(13, 13);
        ...
        public HeartContainer(Texture2D spritesheet, int x, int y)
        {
            this.position.X = x;
            this.position.Y = y;
            this.sprite = new Sprite(Game1.ITEM_SPRITESHEET, x, y,
                new List<Rectangle>() { new Rectangle(25, 1, (int)DefaultSize.X, (int)DefaultSize.Y) });
        }
